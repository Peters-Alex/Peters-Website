...
function Portfolio() {
    ...
    return (
        ...
        <div className="Portfolio">
            ...
            <p className="quote2">“It is not the language that makes programs appear simple. It is the programmer that make the language appear simple!”
            ...
            <div className="cardanchored">
                <div>
                    ...
                    <a className="EcomWeb" href="https://www.linkedin.com/in/alexpetersmba/">LinkedIn</a>
                    <a className="EcomWeb" href="https://trendsphere.netlify.app/"> Trendsphere</a>
                    <p className="EcomWebTxt">This is an E-Commerce Website Demo and not an active site.</p>
                    <a href="https://trendsphere.netlify.app/"> 
                        <button className="Portbutton" onClick={handleClick}>TrendSphere</button>
                    </a>
                </div>
            </div>
        </div>
